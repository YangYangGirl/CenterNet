...
# train
#python main.py --metric loss --down_ratio 16 --task landmark --arch $var_arch --exp_id $var --dataset landmark --num_epochs 300 --batch_size 128 --master_batch 64 --lr 5e-4  --gpus 0 --num_workers 1
# test
