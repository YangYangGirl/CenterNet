...
# train
python main.py --batch_size 32 --num_epochs 100 --metric loss --down_ratio 16 --task landmark --arch $var_arch --exp_id $var --dataset landmark  --master_batch 64 --lr 5e-4  --gpus 0 --num_workers 1
# test
