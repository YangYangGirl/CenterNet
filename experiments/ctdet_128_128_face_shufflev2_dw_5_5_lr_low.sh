var=shuffle_5_128_128_dw_5_5_d_16_6_lr_low
cd ../src
# train
#python main.py --task ctdet --dataset face  --num_epochs 300 --batch_size  32 --master_batch 32   --lr 1.25e-5 --gpus 1  --metric loss  --exp_id  $var  --arch  shuffleDw5_5
# produce output
