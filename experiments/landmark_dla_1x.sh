...
cd ../src
# train
#python main.py --metric loss --down_ratio 4 --task landmark --num_epoch 300 --arch $var_arch --exp_id $var --dataset landmark --load_model ../models/ctdet_coco_dla_2x.pth --num_epochs 1 --batch_size 6 --master_batch 6 --lr 5e-5  --gpus 0 --num_workers 1
