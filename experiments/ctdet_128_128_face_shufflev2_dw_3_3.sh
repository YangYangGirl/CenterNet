var=shuffle_5_128_128_d_16_6_dw_3_3
cd ../src
# train
#python main.py --task ctdet --dataset face  --num_epochs 300 --batch_size  32 --master_batch 32   --lr 1.25e-4 --gpus 1  --metric loss  --exp_id  $var  --arch  shuffle_5
# produce output
