...
PRE_DEFINE_CATEGORIES = {"face": 1}#, "bicycle": 2, "bird": 3, "boat": 4,
...
def create_image_id(filename):
	global noun
	if filename not in all_name2id.keys():
		all_name2id.setdefault(filename, noun+1)
		noun = noun+1
	return all_name2id[filename]
...
def convert(xml_list, xml_dir, json_file):
    ...
    for line in list_fp:
        ...
        image_id = create_image_id(filename) #get_filename_as_int(filename)  # 图片ID
...
if __name__ == '__main__':
    root_path = "/home/yy/github/CenterNet/data/voc/"#os.getcwd()
