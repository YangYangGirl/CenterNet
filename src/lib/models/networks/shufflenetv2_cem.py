...
class PIM_up(nn.Module):
    def __init__(self, inchannel, outchannel):
        ...
        self.net = nn.Sequential(nn.Conv2d(inchannel, outchannel, 3, 1, 0, bias=False),
                                 nn.Upsample(scale_factor=10 / 3, mode='bilinear', align_corners=True))
...
class ShuffleNetV2(nn.Module):
    def __init__(self, heads, head_conv, n_class=1000, input_size=224, width_mult=1.):
        ...
        self.inplanes = self.stage_out_channels[-2]  # 256
    ...
    def forward(self, x):
        ...
        #         print("cem2_input", cem2_input.shape )
        #         print("cem3_input", cem3_input.shape)
        #         print("cem2_output", cem2_output.shape)
        #         print("cem3_output", cem3_output.shape)
        x = cem1_output + cem2_output + cem3_output
        #         x = cem2_output+cem3_output
        #         x = self.cemse(x)
        print("hm shape", x.shape)
        ret = {}
